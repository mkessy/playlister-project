...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'playlists_playlist', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='The name of the playlist', max_length=500)),
            ('creator', self.gf('django.db.models.fields.CharField')(default='The creator of the playlist', max_length=500)),
            ('cover_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(default='A description of the playlist', max_length=500)),
            ('featured_artists', self.gf('django.db.models.fields.CharField')(default='A, list, of, the artists, formatted, like, this', max_length=500)),
        ...
        db.create_table(u'playlists_group', (
            ('groupid', self.gf('django.db.models.fields.CharField')(max_length=500, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='The name of the group', max_length=500)),
            ('keywords', self.gf('django.db.models.fields.CharField')(default='Some, key, words', max_length=500)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=500)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        ...
        db.create_table(u'playlists_category', (
            ('categoryid', self.gf('django.db.models.fields.CharField')(max_length=500, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='The name of the category', max_length=500)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=500)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
